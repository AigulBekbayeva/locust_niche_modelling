...
**🗺 Веб-карта с результатами:** `https://aigulbekbayeva.github.io/locust_niche_modelling/`. На ней показаны карта пригодности, слои среды, исходные точки обследования и точность модели.
